...
DefinitionBlock ("", "SSDT", 2, "DptfTb", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PC00.LPCB.H_EC.DPTF.GFHE, MethodObj)    // 0 Arguments
    External (_SB_.PC00.LPCB.H_EC.DPTF.GFLE, MethodObj)    // 0 Arguments
    External (_SB_.PC00.LPCB.H_EC.DPTF.GFME, MethodObj)    // 0 Arguments
    External (_SB_.PC00.LPCB.H_EC.DPTF.GFNS, MethodObj)    // 1 Arguments
    External (_SB_.PC00.LPCB.H_EC.DPTF.GSHE, MethodObj)    // 0 Arguments
    ...
    External (_SB_.PC00.LPCB.H_EC.DPTF.SFHE, MethodObj)    // 1 Arguments
    External (_SB_.PC00.LPCB.H_EC.DPTF.SFLE, MethodObj)    // 1 Arguments
    ...
    Scope (\_SB)
    {
        OperationRegion (DNVS, SystemMemory, 0x666CC000, 0x0021)
    ...
    Scope (\_SB.IETM)
    {
        Device (TFN1)
        {
            ...
            {
                Return (\_SB.PC00.LPCB.H_EC.DPTF.GFHE ())
            }

            Method (GFLT, 0, Serialized)
            {
                Return (\_SB.PC00.LPCB.H_EC.DPTF.GFLE ())
            }
            ...
            {
                \_SB.PC00.LPCB.H_EC.DPTF.SFLE (Arg0)
            }

            Method (GFSH, 0, Serialized)
            {
                Return (\_SB.PC00.LPCB.H_EC.DPTF.GSHE ())
            }
