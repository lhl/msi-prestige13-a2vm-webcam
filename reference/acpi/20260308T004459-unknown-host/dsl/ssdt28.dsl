    ...
    Scope (\_SB.PC00.I2C0)
    {
        ...
        Device (PA01)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA01._CRS._Y03._ADR, PAAD)  // _ADR: Address
        ...
        Device (PA02)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA02._CRS._Y04._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA03)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA03._CRS._Y05._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA04)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA04._CRS._Y06._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA05)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA05._CRS._Y07._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA06)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA06._CRS._Y08._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA07)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA07._CRS._Y09._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
        ...
        Device (PA08)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (RBUF, 0x1F, PAST)
                CreateWordField (RBUF, \_SB.PC00.I2C0.PA08._CRS._Y0A._ADR, PAAD)  // _ADR: Address
                PAST = PABN /* \_SB_.PC00.I2C0.PABN */
